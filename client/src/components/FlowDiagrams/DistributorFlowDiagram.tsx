...
import { ChevronRight, Package, Warehouse, Truck, CheckCircle } from "lucide-react";

export function DistributorFlowDiagram() {
  const [activeStep, setActiveStep] = useState(0);

  const steps = [
    {
      title: "Publicar Lote de Distribuição",
      description: "Registre produtos em excesso",
      icon: Package,
      details: [
        "Categoria de produtos",
        "Tipo de lote (excedente, próximo vencimento, etc)",
        "Lista de produtos",
        "Quantidade em caixas/kg",
      ],
      color: "from-cyan-500 to-cyan-600",
    },
    {
      title: "Indicar Condição",
      description: "Descreva o estado dos produtos",
      icon: Warehouse,
      details: [
        "Novo ou bom estado",
    ...
    },
    {
      ...
      description: "Opcionalmente, busque as ONGs",
      icon: Truck,
      details: [
    ...
    },
    {
      ...
      description: "Lote é entregue às ONGs",
      icon: CheckCircle,
      details: [
