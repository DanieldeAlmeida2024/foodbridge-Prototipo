...
import { ChevronRight, Heart, CheckCircle, MapPin, Calendar, AlertCircle } from "lucide-react";

export function DonorFlowDiagram() {
  const [activeStep, setActiveStep] = useState(0);

  const steps = [
    {
      title: "Publicar Doação",
      description: "Preencha os dados do alimento",
      icon: Heart,
      details: [
        "Tipo de alimento",
    ...
    {
      title: "Definir Local e Horário",
      description: "Indique onde e quando coletar",
      icon: MapPin,
      details: [
        "Endereço completo",
        "Data de coleta",
    ...
    {
      title: "ONGs Reivindicam",
      description: "Organizações veem sua doação",
      icon: AlertCircle,
      details: [
        "Notificação de interesse",
        "ONG seleciona quantidade",
        "Confirma voluntário",
        "Agenda coleta",
      ],
    ...
    },
    {
      ...
      description: "Alimento é coletado",
      icon: CheckCircle,
      details: [
        "Voluntário busca alimento",
